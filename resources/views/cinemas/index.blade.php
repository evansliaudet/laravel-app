                ...
                <table class="table-auto w-full border-collapse">
                    <thead>
                        <tr class="bg-gray-200 text-gray-700 uppercase text-sm">
                            ...
                            <th class="text-left p-3">{{ __('Address') }}</th>
                    ...
                    <tbody>
                        @foreach($cinemas as $cinema)
                            <tr class="border-b border-gray-200 hover:bg-gray-100 cursor-pointer" 
                                onclick="window.location.href='{{ route('cinema.show', $cinema->id) }}'">
                                <td class="p-3">{{ $cinema->name }}</td>
                                <td class="p-3">{{ $cinema->address }}</td>
                                <td class="p-3">{{ $cinema->phone }}</td>
                                <td class="p-3 space-x-3">
                                    <a href="{{ route('cinema.edit', $cinema->id) }}" class="text-blue-600 hover:underline">
                                        {{ __('Edit') }}
                                    </a>
                                    <a href="{{ route('cinema.destroy', $cinema->id) }}" class="text-red-600 hover:underline delete">
                                        {{ __('Delete') }}
                                    </a>
                                </td>
                            </tr>
