...
Route::delete('artist/{artist}', [ArtistController::class, 'destroy'])->name(
    'artist.destroy'
);
...
Route::get('country/{country}/edit', [CountryController::class, 'edit'])->name(
    'country.edit'
);
Route::put('country/{country}', [CountryController::class, 'update'])->name(
    'country.update'
);
Route::delete('country/{country}', [CountryController::class, 'destroy'])->name(
    'country.destroy'
);
...
Route::post('cinema', [CinemaController::class, 'store'])->name('cinema.store');
...
Route::delete('cinema/{cinema}', [CinemaController::class, 'destroy'])->name(
    'cinema.destroy'
);
...
// Screening routes
Route::get('screening/create', [ScreeningController::class, 'create'])->name(
    'screening.create'
);
...
Route::prefix('movie')->group(function () {
    Route::get("{movie}/artists", [MovieController::class, "artists"])->name(
        "movie.artists"
    );
